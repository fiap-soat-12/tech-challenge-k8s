...
# resource "aws_security_group_rule" "allow_app_to_sonarqube_instance_rds" {
#   type                     = "ingress"
#   from_port                = 5432
#   to_port                  = 5432
#   protocol                 = "tcp"
#   security_group_id        = tolist(data.aws_db_instance.sonarqube_db_instance.vpc_security_groups)[0]
#   source_security_group_id = aws_eks_cluster.eks_cluster.vpc_config[0].cluster_security_group_id
# }
